(function($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function() {
      ...
      // Elements
      var backrounds = this.options.backr == '' ?
      '<button type="button" class="btn dropdown-toggle" data-toggle="dropdown"' + autofocus + '>' +
      '<span class="filter-option pull-left"></span>&nbsp;' +
      '<span class="' + this.options.caret + '" aria-hidden="true"></span>' +
      '</button>'
       :
      '<button type="button" class="dropdown-toggle ' + this.options.backr + '" data-toggle="dropdown"' + autofocus + '>' +
          ...
          text =
            '<span class="media">' +
              '<span class="media-left">' +
                '<img style="width: 35px; height: 35px; " src="' + $this.data('thumbnail') + '" class="media-object" onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'">' +
            '</span>' +
              '<span class="media-body" style="vertical-align:middle;">' + text + subtext + '</span>' +
            '</span>';
